 ...
 * No anchor/strike here: this has never sold for more, so there's nothing
 * honest to cross out (see ValueStack for the one real dollar anchor, the
 * standalone digital price quoted against the free-with-print bundle).
 */
